    ...
    public class ItemTypeManager : Manager
    {
        ...
        public override void Refresh()
        {
            ...
            if (m_ReorderableList != null) {
                ...
                scrollOffset = m_ReorderableList.ScrollView.scrollOffset.y;
            }
            BuildVisualElements();
            if (m_ReorderableList != null) {
                m_ReorderableList.SelectedIndex = selectedIndex;

                // Set the previous scroll offset after the scrollview has been sized.
                if (scrollOffset != 0) {
                    m_ManagerContentContainer.schedule.Execute(() =>
                    {
                        var offset = m_ReorderableList.ScrollView.scrollOffset;
                        offset.y = scrollOffset;
                        m_ReorderableList.ScrollView.scrollOffset = offset;
                    }).StartingIn(10);
                }
            }
        }
