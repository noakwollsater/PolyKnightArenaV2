...
namespace Opsive.UltimateCharacterController.Character
{
    ...
    public class LocalLookSource : MonoBehaviour, ILookSource
    {
        ...
        private void Awake()
        {
            ...
            if (m_LookTransform == null) {
                ...
                if (modelManager != null) {
                    ...
                    animator = GetComponentInChildren<AnimatorMonitor>(true).GetComponent<Animator>();
                }
        ...
        {
            var animator = activeModel.GetComponentInChildren<AnimatorMonitor>(true).GetComponent<Animator>();
