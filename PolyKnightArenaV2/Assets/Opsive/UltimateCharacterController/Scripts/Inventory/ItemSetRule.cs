...
namespace Opsive.UltimateCharacterController.Inventory
{
    ...
    {
        /// <summary>
        /// Is the Item Set a default Item Set Rule?
        /// </summary>
        /// <returns>True if the Item Set is a default Item Set Rule.</returns>
        public virtual bool IsDefaultItemSetRule() { return false; }
    ...
    public abstract class ItemSetRule : ItemSetRuleBase
    {
        ...
        /// </summary>
        /// <returns>True if the Item Set is a default Item Set Rule.</returns>
        public override bool IsDefaultItemSetRule() { return Default; }
