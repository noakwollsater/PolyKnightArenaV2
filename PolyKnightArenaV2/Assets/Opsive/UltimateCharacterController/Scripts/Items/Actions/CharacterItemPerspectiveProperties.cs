...
namespace Opsive.UltimateCharacterController.Items.Actions
{
...
#if FIRST_PERSON_CONTROLLER
            FirstPersonController.Character.FirstPersonObjects firstPersonObjects;
            if (m_ModelManager != null && (firstPersonObjects = m_ModelManager.GetFirstPersonObjects(characterModel)) != null) {
                m_FirstPerspectiveItemObjectParent = firstPersonObjects.gameObject;
            } else if (m_FirstPersonPerspectiveItem != null && (firstPersonObjects = m_FirstPersonPerspectiveItem.GetFirstPersonObjects(characterModel)) != null){
                m_FirstPerspectiveItemObjectParent = firstPersonObjects.gameObject;
            }
#endif
    ...
    public class ItemPerspectiveIDObjectProperty<T> : ItemPerspectiveProperty, IPerspectiveProperty<T> where T : Object
    {
        ...
        {
#if FIRST_PERSON_CONTROLLER
            if (m_FirstPerspectiveItemObjectParent != null && m_FirstPerson.Obj is Component firstPersonComponent && firstPersonComponent != null) {
