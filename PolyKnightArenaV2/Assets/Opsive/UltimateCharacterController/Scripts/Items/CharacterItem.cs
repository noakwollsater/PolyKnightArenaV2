...
namespace Opsive.UltimateCharacterController.Items
{
    ...
    public class CharacterItem : StateBehavior
    {
        ...
        public void Initialize(IItemIdentifier itemIdentifier)
        {
            ...
            // The item may have already been added at runtime. If so, we still want to set the item object's item.
            if (m_Initialized) {
                m_Inventory.OnCharacterItemStartInitializing(this);
            } else {
                Initialize(false);    
        ...
        public virtual void Pickup()
        {
            ...
            SetVisibleObjectActive(m_Inventory.GetActiveCharacterItem(m_SlotID) == this, m_Inventory.GetItemIdentifierAmount(m_ItemIdentifier) > 0, false); 
