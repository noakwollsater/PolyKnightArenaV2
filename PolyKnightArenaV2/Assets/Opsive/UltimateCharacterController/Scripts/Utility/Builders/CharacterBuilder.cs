    ...
    public static class CharacterBuilder
    {
        ...
        public static void AddCollider(GameObject character)
        {
            ...
            if (collider != null) {
                ...
                // Characters should not have decals added to them by default.
                var surfaceIdentifier = collider.AddComponent<SurfaceIdentifier>();
                surfaceIdentifier.AllowDecals = false;
            }
        }
